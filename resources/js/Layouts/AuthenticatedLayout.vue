                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="flex items-center gap-2 ml-2">
                                <InputText placeholder="Search for..." type="text" class="w-32 sm:w-auto" />
                                <Button icon="pi pi-search" />
                            </div>
                        </div>

                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            <Button class="mr-4" icon="pi pi-envelope" />
                            <Button icon="pi pi-bell" />
                            <Divider class="text-gray-500" layout="vertical" />
                            <!-- Settings Dropdown -->
                            <div class="relative">
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            ...
                                            <Avatar image="/images/avatar/men.jpg" shape="circle" />
                                        </span>
                                    </template>
